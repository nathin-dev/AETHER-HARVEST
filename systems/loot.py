...
LOOT_TYPES = {
    "hp_potion":   {"color": (80,255,120),  "glow":(120,255,160), "icon":"♥", "duration":0,   "radius":12},
    "speed_boost": {"color": (255,200,50),   "glow":(255,230,120), "icon":"↑", "duration":8.0, "radius":12},
    "damage_amp":  {"color": (255,100,50),   "glow":(255,160,100), "icon":"⚡","duration":6.0, "radius":12},
    "magnet":      {"color": (180,100,255),  "glow":(220,160,255), "icon":"◈", "duration":5.0, "radius":12},
    "shield":      {"color": (100,200,255),  "glow":(160,230,255), "icon":"◉", "duration":0,   "radius":12},
    "time_warp":   {"color": (200,80,255),   "glow":(240,140,255), "icon":"◷", "duration":4.0, "radius":12},
}

DROP_CHANCES = {
    "void_wisp":    [("hp_potion",0.08),("speed_boost",0.05),("magnet",0.04)],
    "crystal_golem":[("hp_potion",0.15),("damage_amp",0.10),("shield",0.08)],
...
class LootOrb:
    ...
    def draw(self, surf, cam, font_xs):
        ...
        surf.blit(gs, (sx-r*2, sy-r*2), special_flags=pygame.BLEND_ADD)
