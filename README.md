...
Works fully offline
No installation required
Designed for fast sessions and replayability
...
Infinite Harvest is a 2D incremental automation game built from scratch using Python and Pygame, focused on resource collection, upgrades, and scalable progression systems.
